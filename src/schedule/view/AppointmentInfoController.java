...
import static schedule.SchedulingApplication.addAppointment;
import static schedule.SchedulingApplication.getNextID;
import static schedule.SchedulingApplication.lang;
import static schedule.SchedulingApplication.updateAppointment;
import static schedule.SchedulingApplication.validateAppointmentTime;
...
public class AppointmentInfoController  {
	...
	private void initFields(Appointment appt) {
		if(appt != null) {
			...
			reminders = SchedulingApplication.getReminders(appt); 
	...
	private void handleAddReminder() {
		try {
			...
			loader.setLocation(SchedulingApplication.class.getResource("view/AddReminderView.fxml"));
			...
			addReminderStage.setTitle(lang.getString("addReminderButton"));
			addReminderStage.initModality(Modality.WINDOW_MODAL);
			addReminderStage.initOwner(stage);
			addReminderStage.getIcons().add(new Image("reminder_icon.png"));
			...
			AddReminderViewController controller = loader.getController();
	...
	private void handleSave() {
		...
		try {
			...
			if(customer ==  null) throw new IllegalArgumentException(lang.getString("customer") + " " + lang.getString("missingInfoMessage"));
